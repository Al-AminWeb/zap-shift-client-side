            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" {...register("age", { required: true })} className="input input-bordered w-full" />
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" {...register("nid", { required: true })} className="input input-bordered w-full" />
                        {errors.nid && <span className="text-error text-sm">NID is required</span>}
                    </div>
                    <div>
                        <label className="label">Bike Brand</label>
                        <input type="text" {...register("bikeBrand", { required: true })} className="input input-bordered w-full" />
                        {errors.bikeBrand && <span className="text-error text-sm">Required</span>}
                    </div>
                    <div>
                        <label className="label">Bike Registration No</label>
                        <input type="text" {...register("bikeNumber", { required: true })} className="input input-bordered w-full" />
